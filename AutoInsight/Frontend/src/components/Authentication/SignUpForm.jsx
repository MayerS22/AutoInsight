...
import OptionsSelector from "./AuthenticationComponents/OptionsSelector";
...
const SignUp = ({ toggleForm }) => {
  ...
  const validateForm = () => {
    const newErrors = {
      ...
      jobTitle: !isNotEmpty(formData.jobTitle) ? "Please select a job title." : "",
      country: !isNotEmpty(formData.country) ? "Please select a country." : "",
  ...
  return (
    <>
      <div className="flex flex-col items-center text-center relative bottom-20 mt-20">
