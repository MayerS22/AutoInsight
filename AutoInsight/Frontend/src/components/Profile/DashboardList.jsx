...
function Dashboardlist({isProfileLoading,profilePicture,username,getInitials,
    handleProfilePictureClick,isUploadingProfile,
    profileInputRef,handleProfilePictureUpload,handleUploadClick,
    isLoading,fileInputRef,handleFileChange,isDashboardLoading,dashboardList,setHoveredDashboardId,
    hoveredDashboardId,clickedDashboardId,handlePermissionClick,popupRef,handleDownload,navigate,handleDelete
}){
    return (
        <>
            ...
            {dashboardList.map((dataset, idx) => (
              ...
              >
                ...
                <div className="flex flex-col md:flex-row flex-1 justify-center md:justify-start mt-4 md:mt-0 text-center md:text-left w-full items-center">
                  ...
                  >
                    {dataset.permissions.length===0?<span>no users have permission</span>:<span>{dataset.permissions.length} users have permission</span> }
