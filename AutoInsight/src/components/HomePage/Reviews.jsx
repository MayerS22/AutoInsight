...
const Reviews = ({ isLoggedIn }) => {
    ...
    return (
      <div className="max-w-4xl mx-auto py-10">
        {/* Header Section with Text on Left & Button on Right */}
        ...
        <div className="flex gap-6 mt-8 overflow-x-auto no-scrollbar">
          {reviews.map((review) => (
            <div
              key={review.id}
              className="bg-purple-100 rounded-lg shadow-md p-4 min-w-[280px]"
            >
        ...
        <button className="mt-4 bg-purple-900 text-white p-3 rounded-full shadow-lg hover:bg-purple-700">
          <FaChevronRight />
        </button>
        </div>
